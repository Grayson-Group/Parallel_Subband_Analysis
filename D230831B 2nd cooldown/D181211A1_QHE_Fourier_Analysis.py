...
def get_csv_data(file_path : str,file_name: str,R_ind : list[str], VoverI = 1e6 ):
    os.chdir(file_path)
    file = file_name
...
def get_dat_data(file_path : str,file_name: str,R_ind : list[str], VoverI = 1e6, has_header=False, data_headings =[] ):
    ...
    if data_headings == []:
        ...
        if has_header == False:
            ...
            data['Rxx_x'] = data[data_headings[1]]     # data_headings 1 = Rxx_x
            data['Rxx_y'] = data[data_headings[2]]     # data_headings 1 = Rxx_y
            data['Rxy_x'] = data[data_headings[3]]     # data_headings 1 = Rxy_x
            data['Rxy_y'] = data[data_headings[4]]     # data_headings 1 = Rxy_y
